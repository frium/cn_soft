...
public class AIUtil extends WebSocketListener {
    ...
    public static final String appid = "c705d6ea";
    public static final String apiSecret = "MDU2NzA2ZjUwZDZiNzkzNjY4ODU0MDBi";
    public static final String apiKey = "12d4ee8d1f52675287e09ecadc3c44f3";
    ...
    // 主函数
    public static void AIAnswer(String newQuestion) throws Exception {
